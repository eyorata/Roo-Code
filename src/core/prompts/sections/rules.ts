...
- Before using any mutating tool (write_to_file, apply_diff, edit, execute_command, apply_patch, search_replace, edit_file), you must call select_active_intent(intent_id, intent_type, summary) to establish intent context for this turn.
